<div class="header">
    GLOBAL AITOOLYFY TOOLS
    <!-- DARK MODE ICON -->
    <span id="darkToggle" onclick="toggleDarkMode()" style="cursor:pointer; float:right;">
        🌙
    </span>
</div>

<div class="tools ultra-nav" id="toolsNav">
    <div class="nav-indicator" id="navIndicator"></div> <!-- 🔥 ADD THIS -->
